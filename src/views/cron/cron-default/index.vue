    ...
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="周">
        <el-radio-group v-model="type" size="mini" @change="getValue">
          ...
          <div class="box-bottom">
            <el-radio label="12" size="mini" border>每周一至周五0点整执行</el-radio>
          </div>
          <div class="box-bottom">
            <el-radio label="13" size="mini" border>每周末0点整执行</el-radio>
          </div>
          <div class="box-bottom cycle">
            <el-radio label="14" size="mini" border>自定义执行星期和时分</el-radio>
            <div style="margin-top:8px;">
              ...
              <el-input-number
                ...
                style="width: 100px;"
              ></el-input-number>
              <span style="margin:0 8px;">({{weekFormat[weekDay.week]}})</span>
              <el-input-number
                @change="getChangeWeekTime"
      ...
      <el-tab-pane label="月">
        <el-radio-group v-model="type" size="mini" @change="getValue">
          ...
          <div class="box-bottom cycle">
            <el-radio label="23" size="mini" border>自定义执行日和时分</el-radio>
            <div style="margin-top:8px;">
